...
function preload() {
  ...
  logo = loadImage("images/BBC.png");
  clown = loadImage("images/clown cropped.png");
  car = loadImage("images/car cropped.png");
  house = loadImage("images/house cropped.png");
...
function setup() {
  ...
  paintWindow = new PaintWindow(50, 20, 820, 550, "BeauBeaus - Paint");
  drawHomePage();
}
...
function drawHomePage() {
  ...
  clownButton = createImg("images/clown.png", "Clown Canvas");
  ...
  carButton = createImg("images/car.png", "Car Canvas");
  ...
  houseButton = createImg("images/house.png", "House Canvas");
...
function draw() {
  background("teal"); // Influences the background
  paintWindow.draw();
